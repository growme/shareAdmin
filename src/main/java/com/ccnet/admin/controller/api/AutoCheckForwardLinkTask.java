 ...
 *
 */
public class AutoCheckForwardLinkTask implements Job {
	
	   /* 日志对象 */
    private static final Logger LOG = Logger.getLogger(AutoCheckForwardLinkTask.class);
	...
	public void execute(JobExecutionContext context){	
    	...
    	try {
    		//开始处理
    		AutoCheckForwardLinkHelper.autoCheckForwardLink();
			// 保存日志
