...
<body class="bodybg">
				...
				<div class="widget">
					...
					<div class="widget-body">
						<div role="grid" id="simpledatatable_wrapper"
							...
							<form id="searchForm" action="${basePath}backstage/member/index"
								method="post">
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<thead>
										<tr role="row">
											...
											<th class="text-center">提现名称</th>
											<th class="text-center">提现金额</th>
											<th class="text-center">是否第一次提现</th>
										...
										<c:if test="${!empty pm}">
											<c:forEach var="dp" varStatus="status" items="${pm.results}">
												<tr>
													...
													<td class="text-center"><c:if test="${dp.type==1}">
															首次提现
														</c:if> <c:if test="${dp.type==0}">
															非首次提现
														</c:if></td>
													<td class="text-center">${dp.descs}</td>
												</tr>
											</c:forEach>
										</c:if>
	...
	<script src="${basePath}static/js/adminjp/withdrawMoney/withdrawMoney.js"></script>
</body>
<!--  /Body -->
</html>
