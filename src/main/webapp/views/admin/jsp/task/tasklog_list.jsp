...
<body class="bodybg">
							...
							<div class="widget">
								...
								<div class="widget-body">
									<div role="grid" id="simpledatatable_wrapper" class="dataTables_wrapper form-inline no-footer">
										...
										<form action="${basePath}backstage/tasklog/index" method="post">
										<div id="simpledatatable_filter" class="dataTables_filter">
											<label class="no-margin-left">
												<input type="text" name="queryParam" id="queryParam" placeholder="请输入关键词" class="form-control input-sm" value="${queryParam}"/>
											...
											<c:if test="${!empty pm}">
											   <c:forEach var="dp" varStatus="status" items="${pm.results}">
												<tr>
													<td>
														<label>
				                                            <input type="checkbox" name="ck" id="ck_${dp.logId}" value="${dp.logId}">
				                                            <span class="text"></span>
				                                        </label>
													</td>
													<td>
													...
													<td>
														<c:if test="${dp.logType==1}">
															<font color=green>正常</font>
													    </c:if>
													    <c:if test="${dp.logType==2}">
												...
												<tr><td colspan="7" align="center" style="font-size:14px;color:red">很抱歉,没有查询到您要的数据</td></tr>
												</c:if>
												  ...
												  <tr>
													...
													<div class="col-sm-6 no-padding">
														<div class="dataTables_paginate paging_bootstrap" id="simpledatatable_paginate">
															<ul class="pagination">
																<pg:pager url="${basePath}backstage/tasklog/index"
	...
	<script src="${basePath}static/js/admin/task/taskLogs.js"></script>
</body>
<!--  /Body -->
</html>
