								   ...
								   <c:if test="${ADMIN_VERSION!='V5'}">
									...
									<div class="widget-body">
										<div role="grid" id="simpledatatable_wrapper" class="dataTables_wrapper form-inline no-footer">
											...
											<form action="${basePath}backstage/role/index" method="post">
												...
												<c:if test="${!empty pm}">
												   <c:forEach var="dp" varStatus="status" items="${pm.results}">
													<tr>
														<td>
															<label>
					                                            <input type="checkbox" name="ck" id="ck_${dp.roleId}" value="${dp.roleId}">
					                                            <span class="text"></span>
					                                        </label>
														</td>
														<c:if test="${!empty permitTBtn}">
														...
														<a href="javascript:${btn.btnFun}('${dp.roleId}');" id="${btn.btnId}" title="${btn.resourceName}"><i class="${btn.icon} sz14"></i></a>
														</c:forEach>
														</td>
														</c:if>
														...
														<td>
															${fn:substring(dp.createTime, 0, 19)}
														</td>
												      ...
												      <td colspan="9">
														...
														<div class="col-sm-6 no-padding">
															<div class="dataTables_paginate paging_bootstrap" id="simpledatatable_paginate">
																<ul class="pagination">
																	<pg:pager url="${basePath}backstage/role/index"
