...
<body class="bodybg">
								...
								<div class="widget-body">
									<div role="grid" id="simpledatatable_wrapper" class="dataTables_wrapper form-inline no-footer">
									   ...
									   <c:if test="${!empty permitFBtn}">
										...
										<form id="searchForm" action="${basePath}backstage/drank/index" method="post">
												   ...
												   <td colspan="10">
														...
														<div class="col-sm-6 no-padding">
															<div class="dataTables_paginate paging_bootstrap" id="simpledatatable_paginate">
																<ul class="pagination">
																<pg:pager url="${basePath}backstage/drank/index"
	...
	<script src="${basePath}static/js/admincps/rank/today_rank.js"></script>
</body>
<!--  /Body -->
</html>
