...
<body class="bodybg">
								...
								<div class="widget-body">
									<div role="grid" id="simpledatatable_wrapper" class="dataTables_wrapper form-inline no-footer">
									   ...
									   <c:if test="${!empty permitFBtn}">
										...
										<form id="searchForm" action="${basePath}backstage/trank/index" method="post">
											...
											<c:if test="${!empty pm}">
											   <c:forEach var="dp" varStatus="status" items="${pm.results}">
												<tr>
													<td>
													<label>
		                                            <input type="checkbox" name="ck" id="ck_${dp.rankId}" value="${dp.rankId}">
		                                            <span class="text"></span>
			                                        </label>
													</td>
													...
													<c:forEach var="btn" items="${permitTBtn}">
													   <a href="javascript:${btn.btnFun}('${dp.rankId}');" id="${btn.btnId}" title="${btn.resourceName}"><i class="${btn.icon} sz14"></i></a>
													</c:forEach>
													</td>
													</c:if>
													<td class="text-center">
													...
													<td> 
														<fmt:formatDate value="${dp.updateTime}" type="both" pattern="yyyy年MM月dd日 HH:mm:ss"/>  
													 </td>
												</tr>
												</c:forEach>
												</c:if>
												   ...
												   <td colspan="10">
														...
														<div class="col-sm-6 no-padding">
															<div class="dataTables_paginate paging_bootstrap" id="simpledatatable_paginate">
																<ul class="pagination">
																<pg:pager url="${basePath}backstage/trank/index"
	...
	<script src="${basePath}static/js/admincps/rank/total_rank.js"></script>
</body>
<!--  /Body -->
</html>
