	                                ...
	                                <div class="widget-body">
										<div role="grid" id="simpledatatable_wrapper" class="dataTables_wrapper form-inline no-footer">
										   <c:if test="${!empty permitFBtn}">
											...
											<form action="${basePath}backstage/report/order/good" method="post">
												...
												<c:if test="${!empty pm}">
												   <c:forEach var="dp" varStatus="status" items="${pm.results}">
													<tr>
														...
														<td class="text-center">
															<font <c:if test="${dp.totalOrderCount.totalMoney > 0}">color="blue"</c:if> >
															<fmt:formatNumber value="${dp.totalOrderCount.totalMoney}" type="currency" pattern="0.00"/>
															</font>
														</td>
														<td class="text-center">
															<font <c:if test="${dp.totalOrderCount.money > 0}">color="blue"</c:if> >
															<fmt:formatNumber value="${dp.totalOrderCount.money}" type="currency" pattern="0.00"/>
															</font>
														</td>
														...
														<c:forEach var="colStep" items="${dp.orderStepCountList}">
														 ...
														 <td class="text-center">
														 	<font <c:if test="${colStep.totalMoney > 0}">color="blue"</c:if> >
														 	<fmt:formatNumber value="${colStep.totalMoney}" type="currency" pattern="0.00"/>
														 	</font>
														 </td>
														 <td class="text-center">
														 	<font <c:if test="${colStep.money > 0}">color="blue"</c:if> >
														 	<fmt:formatNumber value="${colStep.money}" type="currency" pattern="0.00"/>
														 	</font>
														 </td>
														</c:forEach>
													</tr>
													   ...
													   <td colspan="30">
															...
															<div class="col-sm-6 no-padding">
																<div class="dataTables_paginate paging_bootstrap" id="simpledatatable_paginate">
																	<ul class="pagination">
																		<pg:pager url="${basePath}backstage/report/order/good"
