$(function() {
	...
	one_option = {
	 ...
	 one_option.series[0].pointer.color='#FF4351'
	...
	var timeTicket = setInterval(function() {
		...
		$.ajax({
			type : "POST",
			url : locat + '/backstage/monitor/usage',
			async : false,
			dataType : 'json',
			success : function(json) {
				$("#td_jvmUsage").html(json.obj.jvmFree);
				$("#td_serverUsage").html(json.obj.memFree);
				$("#td_cpuUsage").html(json.obj.cpuUsage);
				
				jvm.push(json.obj.jvmUsage);
				ram.push(json.obj.ramUsage);
				cpu.push(json.obj.cpuUsage);
				// 动态数据接口 addData
				...
				one_option.series[0].data[0].value =json.obj.jvmUsage;
				one_option.series[0].data[0].name ='JVM使用率';
				 one_option.series[0].pointer.color='#FF4351'
				main_one.setOption(one_option, true);
				
				two_option.series[0].data[0].value =json.obj.cpuUsage;
				main_two.setOption(two_option, true);
				
				one_option.series[0].data[0].value =json.obj.ramUsage;
				 one_option.series[0].data[0].name ='内存使用率';
				 one_option.series[0].pointer.color='#FF4351'
